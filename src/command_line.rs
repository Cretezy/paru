...
impl Config {
    ...
    fn handle_arg(
        ...
        match arg {
            ...
            Arg::Long("aursecurityremoteurl") | Arg::Long("aursecurityurl") => {
                self.aur_security_remote_url = Url::parse(value?)?
            }
...
fn takes_value(arg: Arg) -> TakesValue {
    match arg {
        ...
        Arg::Long("aursecurityremoteurl") | Arg::Long("aursecurityurl") => TakesValue::Required,
